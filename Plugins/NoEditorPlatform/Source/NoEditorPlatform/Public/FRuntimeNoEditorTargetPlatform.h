...
#include "Developer/Windows/WindowsTargetPlatform/Private/LocalPcTargetDevice.h"
...
#define LOCTEXT_NAMESPACE "FRuntimeNoEditorPlatform"

#define HAS_EDITOR_DATA false
#define IS_DEDICATED_SERVER false
...
public:
	...
	FRunTimeNoEditorTargetPlatform()
	{
#if PLATFORM_WINDOWS
...
public:
	...
	DECLARE_DERIVED_EVENT(FRunTimeNoEditorTargetPlatform, ITargetPlatform::FOnTargetDeviceDiscovered, FOnTargetDeviceDiscovered);
	virtual FOnTargetDeviceDiscovered& OnDeviceDiscovered() override
	{
		return DeviceDiscoveredEvent;
	}

	DECLARE_DERIVED_EVENT(FRunTimeNoEditorTargetPlatform, ITargetPlatform::FOnTargetDeviceLost, FOnTargetDeviceLost);
